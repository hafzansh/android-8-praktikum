...
import 'package:praktikum_8/models/utils.dart';
import 'package:praktikum_8/views/components/drop_down_List.dart';
...
Drawer sideDrawer(NewsController newsController) {
  return Drawer(
    ...
    children: [
      ...
      Container(
        child: Row(children: [
          ...
          MaterialButton(
            ...
            onPressed: ()async {
            newsController.getNews(searchKey: newsController.findNews.value);
          })
        ]),
      ),

      ExpansionTile(title: const Text("Country"),children: <Widget> [
      ...
      ExpansionTile(title: const Text("Category"),children: <Widget> [
      ...
      ExpansionTile(title: const Text("Channel"),children: <Widget> [
